...
import AjetreoLogo from '../public/images/logo-full.svg'
import AjetreoLogoInverted from '../public/images/logo-full.svg'
...
const Logo = () => (
  <LogoWrapper>
    <LogotypeWrapper href='/'>
      <img src={AjetreoLogo} alt='Storybook' />
    </LogotypeWrapper>
    <Version href='https://github.com/ajetreo/design-system/releases'>
      v6.0
    </Version>
  </LogoWrapper>
)
...
export const Basic = () => (
  <Header logo={<Logo />} links={links} mobileMenu={mobileMenu} />
)
    ...
    <Header
      ...
      logo={
        <InvertedLogotypeWrapper href='/' inverse>
          <img src={AjetreoLogoInverted} alt='Ajetreo' />
